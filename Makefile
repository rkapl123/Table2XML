...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: '\''1.41'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : "1.41",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="XML-Table2XML" VERSION="1.41">' > XML-Table2XML.ppd
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.32" />' >> XML-Table2XML.ppd
